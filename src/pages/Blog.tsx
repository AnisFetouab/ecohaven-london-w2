    ...
    <div className="pt-20">
      <div className="page-container section-padding">
        ...
        <div className="max-w-3xl mx-auto prose prose-green lg:prose-lg">
          ...
          <div className="whitespace-pre-line">{content[language].crisisContent}</div>

          <h2>The Future: A Shift Towards Sustainable Real Estate</h2>
          <div className="whitespace-pre-line">{content[language].futureContent}</div>

          <h2>Looking Ahead: A Call to Action for Businesses and Consumers</h2>
          <div className="whitespace-pre-line">{content[language].callToActionContent}</div>
        </div>
      </div>
    </div>
  );
